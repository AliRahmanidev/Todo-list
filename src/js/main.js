...
let todoToEditId; // DECLRAE GLOBAL VARIABLE

function openEditForm(e) {
  // const todoToEditId = Number(e.target.dataset.todoId);
...
function updateTodo(e) {
  ...
  todo.title = editTodoInput.value; // updated value for todo Title
  saveAllTodos(todos);
  filterTodos();
}

// 1. open modal => modal, backdrop => click => show modal
// 2. edit btn => click to open modal
// 3. edit todo input on form => update =>
// 4. localstorage and UI => update
